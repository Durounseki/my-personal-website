function PublicationCard({publication}){
    return (
        <article className="publication">
            ...
            {publication.link !== "" ? <a className="publication-link" href={publication.link} target="_blank" rel="noreferrer noopener">Preprint <i class="fa-solid fa-angles-right"></i></a> : ""}
